...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { 
    if (isset($_POST['register_candidate'])) {
        ...
        $qry2 = "INSERT INTO candidate (voter_id, position_id, candidate_details, platform, party_code, date_applied, status) 
                 VALUES ('$voter_id', '$position_id', '$details', '$platform', '$party_id', NOW(), 'Under Review')";

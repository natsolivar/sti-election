        ...
        if ($results) {
            ...
            if ($result_votes) {
                ...
                while ($row_votes = mysqli_fetch_assoc($result_votes)) {
                    ...
                    if (!empty($president) && !in_array($president, $_SESSION['voted_candidates'])) {
                        echo "Processing candidate: $pres<br>";
                        ...
                        if ($result_pres && mysqli_num_rows($result_pres) > 0) {
                            ...
                            echo "Found candidate ID: $candidate_id_pres<br>";
                            

                            $query = "SELECT voter_grade FROM voters WHERE voter_id = '$voter_id'";
                            $query_result = mysqli_query($conn, $query);
            
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                $row = mysqli_fetch_assoc($query_result);
            
                                if (isset($row['voter_grade'])) { 
                                    $voter_grade = $row['voter_grade']; 
                                    echo "Voter grade: $voter_grade<br>";
                                    ...
                                    if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_pres;
                                        $processed_candidates[] = $pres;
                                    }
                                } 
                            } 
                        ...
                        if ($result_vp && mysqli_num_rows($result_vp) > 0) {
                            ...
                            if (!isset($voter_id)) {
                                die("Error: voter_id is not defined.");
                            }
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_vp, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                            ...
                                            if (!$update_result_pres) {
                                                die("Error updating SHvote_count: " . mysqli_error($conn));
                                            }
                                        } else {
                                            $qry5 = "UPDATE votes SET TERvote_count = TERvote_count + 1, date_updated = NOW() WHERE candidate_id = '$candidate_id_vp'";
                                            $update_result_pres = mysqli_query($conn, $qry5);
                                            if (!$update_result_pres) {
                                                die("Error updating TERvote_count: " . mysqli_error($conn));
                                            }
                                        }
            
                                        $_SESSION['voted_candidates'][] = $candidate_id_vp;
                                    }
                                } 
                            } 
                        ...
                        if ($result_shvp && mysqli_num_rows($result_shvp) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_shvp, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_shvp;
                                    }
                                } 
                            } 
                        ...
                        if ($result_intsec && mysqli_num_rows($result_intsec) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_intsec, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_intsec;
                                    }
                                } 
                            } 
                        ...
                        if ($result_extsec && mysqli_num_rows($result_extsec) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_extsec, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_extsec;
                                    }
                                } 
                            } 
                        ...
                        if ($result_trea && mysqli_num_rows($result_trea) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_trea, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_trea;
                                    }
                                } 
                            } 
                        ...
                        if ($result_aud && mysqli_num_rows($result_aud) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_aud, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_aud;
                                    }
                                } 
                            } 
                        ...
                        if ($result_pio && mysqli_num_rows($result_pio) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_pio, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_pio;
                                    }
                                } 
                            } 
                        ...
                        if ($result_11abmrep && mysqli_num_rows($result_11abmrep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_11abmrep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_11abmrep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_11humssrep && mysqli_num_rows($result_11humssrep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_11humssrep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_11humssrep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_11stemrep && mysqli_num_rows($result_11stemrep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_11stemrep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_11stemrep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_11cuartrep && mysqli_num_rows($result_11cuartrep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_11cuartrep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_11cuartrep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_11mawdrep && mysqli_num_rows($result_11mawdrep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_11mawdrep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_11mawdrep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_12abmrep && mysqli_num_rows($result_12abmrep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_12abmrep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_12abmrep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_12humssrep && mysqli_num_rows($result_12humssrep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_12humssrep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_12humssrep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_12cuartrep && mysqli_num_rows($result_12cuartrep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_12cuartrep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_12cuartrep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_12mawdrep && mysqli_num_rows($result_12mawdrep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_12mawdrep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_12mawdrep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_bstm1arep && mysqli_num_rows($result_bstm1arep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_bstm1arep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_bstm1arep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_bstm1brep && mysqli_num_rows($result_bstm1brep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_bstm1brep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_bstm1brep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_bstm3rep && mysqli_num_rows($result_bstm3rep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_bstm3rep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_bstm3rep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_bstm4rep && mysqli_num_rows($result_bstm4rep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_bstm4rep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_bstm4rep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_bsis1rep && mysqli_num_rows($result_bsis1rep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_bsis1rep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_bsis1rep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_bsis2rep && mysqli_num_rows($result_bsis2rep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_bsis2rep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_bsis2rep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_bsis3rep && mysqli_num_rows($result_bsis3rep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_bsis3rep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_bsis3rep;
                                    }
                                } 
                            } 
                        ...
                        if ($result_bsis4rep && mysqli_num_rows($result_bsis4rep) > 0) {
                            ...
                            if ($query_result && mysqli_num_rows($query_result) > 0) {
                                ...
                                if (isset($row['voter_grade'])) { 
                                    ...
                                    if (!in_array($candidate_id_bsis4rep, $_SESSION['voted_candidates'])) {
                                        if ($voter_grade == 'g11' || $voter_grade == 'g12') {
                                        ...
                                        $_SESSION['voted_candidates'][] = $candidate_id_bsis4rep;
                                    }
                                } 
                            } 
